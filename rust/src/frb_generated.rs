...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -18626695;
...
fn wire__crate__api__voting__parse_signed_voting_pczt_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "parse_signed_voting_pczt",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::voting::parse_signed_voting_pczt(
...
impl SseDecode for crate::api::voting::ParsedSignedVotingPczt {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_sighash = <Vec<u8>>::sse_decode(deserializer);
        let mut var_spendAuthSig = <Vec<u8>>::sse_decode(deserializer);
        return crate::api::voting::ParsedSignedVotingPczt {
            sighash: var_sighash,
            spend_auth_sig: var_spendAuthSig,
        };
    }
...
5 => wire__crate__api__sync__broadcast_due_orchard_migration_transactions_impl(port, ptr, rust_vec_len, data_len),
6 => wire__crate__api__sync__broadcast_one_due_orchard_migration_transaction_impl(port, ptr, rust_vec_len, data_len),
7 => wire__crate__api__voting__build_keystone_delegation_request_impl(port, ptr, rust_vec_len, data_len),
8 => wire__crate__api__voting__build_prove_and_sign_delegation_payload_with_progress_impl(port, ptr, rust_vec_len, data_len),
9 => wire__crate__api__voting__build_prove_delegation_payload_with_keystone_signature_with_progress_impl(port, ptr, rust_vec_len, data_len),
10 => wire__crate__api__voting__build_vote_commitments_with_progress_impl(port, ptr, rust_vec_len, data_len),
12 => wire__crate__api__voting__check_voting_eligibility_impl(port, ptr, rust_vec_len, data_len),
13 => wire__crate__api__voting__clear_recovery_state_impl(port, ptr, rust_vec_len, data_len),
14 => wire__crate__api__sync__complete_orchard_migration_batch_pczt_impl(port, ptr, rust_vec_len, data_len),
15 => wire__crate__api__sync__complete_orchard_migration_denominations_pczt_impl(port, ptr, rust_vec_len, data_len),
16 => wire__crate__api__sync__complete_orchard_migration_immediate_pczt_impl(port, ptr, rust_vec_len, data_len),
17 => wire__crate__api__sync__complete_orchard_migration_single_qr_pczt_impl(port, ptr, rust_vec_len, data_len),
18 => wire__crate__api__simple__configure_fast_testnet_migration_impl(port, ptr, rust_vec_len, data_len),
19 => wire__crate__api__simple__configure_regtest_ironwood_activation_height_impl(port, ptr, rust_vec_len, data_len),
20 => wire__crate__api__voting__confirm_delegation_submission_impl(port, ptr, rust_vec_len, data_len),
21 => wire__crate__api__voting__confirm_vote_submission_impl(port, ptr, rust_vec_len, data_len),
22 => wire__crate__api__sync__create_or_resume_private_migration_draft_impl(port, ptr, rust_vec_len, data_len),
23 => wire__crate__api__sync__create_pczt_from_proposal_impl(port, ptr, rust_vec_len, data_len),
24 => wire__crate__api__sync__create_shield_transparent_pczt_impl(port, ptr, rust_vec_len, data_len),
25 => wire__crate__api__wallet__create_wallet_impl(port, ptr, rust_vec_len, data_len),
26 => wire__crate__api__keystone__decode_accounts_from_cbor_impl(port, ptr, rust_vec_len, data_len),
27 => wire__crate__api__keystone__decode_accounts_ur_impl(port, ptr, rust_vec_len, data_len),
28 => wire__crate__api__keystone__decode_pczt_from_cbor_impl(port, ptr, rust_vec_len, data_len),
29 => wire__crate__api__keystone__decode_ur_part_impl(port, ptr, rust_vec_len, data_len),
30 => wire__crate__api__keystone__decode_ur_to_pczt_impl(port, ptr, rust_vec_len, data_len),
31 => wire__crate__api__keystone__decode_zcash_batch_sign_response_impl(port, ptr, rust_vec_len, data_len),
32 => wire__crate__api__keystone__decode_zcash_sign_result_cbor_impl(port, ptr, rust_vec_len, data_len),
33 => wire__crate__api__keystone__decode_zcash_sign_result_cbor_as_sig_result_impl(port, ptr, rust_vec_len, data_len),
34 => wire__crate__api__sync__decrypt_and_store_transaction_impl(port, ptr, rust_vec_len, data_len),
35 => wire__crate__api__secret__decrypt_secret_payload_impl(port, ptr, rust_vec_len, data_len),
36 => wire__crate__api__voting__delegation_submission_wire_json_impl(port, ptr, rust_vec_len, data_len),
37 => wire__crate__api__wallet__delete_account_impl(port, ptr, rust_vec_len, data_len),
38 => wire__crate__api__voting__delete_skipped_bundles_impl(port, ptr, rust_vec_len, data_len),
39 => wire__crate__api__voting__delete_voting_account_state_impl(port, ptr, rust_vec_len, data_len),
40 => wire__crate__api__wallet__derive_next_software_account_impl(port, ptr, rust_vec_len, data_len),
41 => wire__crate__api__secret__derive_secret_password_verifier_impl(port, ptr, rust_vec_len, data_len),
42 => wire__crate__api__sync__discard_all_keystone_migration_requests_impl(port, ptr, rust_vec_len, data_len),
43 => wire__crate__api__sync__discard_keystone_migration_request_impl(port, ptr, rust_vec_len, data_len),
44 => wire__crate__api__sync__discard_proposal_impl(port, ptr, rust_vec_len, data_len),
45 => wire__crate__api__wallet__discover_software_wallet_import_accounts_impl(port, ptr, rust_vec_len, data_len),
46 => wire__crate__api__keystone__encode_pczt_to_ur_impl(port, ptr, rust_vec_len, data_len),
47 => wire__crate__api__keystone__encode_pczt_ur_parts_impl(port, ptr, rust_vec_len, data_len),
48 => wire__crate__api__keystone__encode_zcash_sign_batch_ur_parts_impl(port, ptr, rust_vec_len, data_len),
49 => wire__crate__api__secret__encrypt_secret_payload_impl(port, ptr, rust_vec_len, data_len),
50 => wire__crate__api__wallet__ensure_wallet_db_migrated_impl(port, ptr, rust_vec_len, data_len),
51 => wire__crate__api__sync__estimate_fee_impl(port, ptr, rust_vec_len, data_len),
52 => wire__crate__api__sync__estimate_send_max_impl(port, ptr, rust_vec_len, data_len),
53 => wire__crate__api__wallet__evict_wallet_summary_cache_impl(port, ptr, rust_vec_len, data_len),
54 => wire__crate__api__sync__execute_proposal_impl(port, ptr, rust_vec_len, data_len),
55 => wire__crate__api__sync__execute_proposal_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
56 => wire__crate__api__sync__export_orchard_migration_outbox_impl(port, ptr, rust_vec_len, data_len),
57 => wire__crate__api__sync__extract_and_broadcast_pczt_impl(port, ptr, rust_vec_len, data_len),
59 => wire__crate__api__voting__generate_van_witness_impl(port, ptr, rust_vec_len, data_len),
60 => wire__crate__api__voting__generate_voting_hotkey_impl(port, ptr, rust_vec_len, data_len),
61 => wire__crate__api__wallet__get_account_export_metadata_impl(port, ptr, rust_vec_len, data_len),
62 => wire__crate__api__sync__get_balance_impl(port, ptr, rust_vec_len, data_len),
63 => wire__crate__api__sync__get_block_time_impl(port, ptr, rust_vec_len, data_len),
65 => wire__crate__api__wallet__get_chain_upgrade_status_impl(port, ptr, rust_vec_len, data_len),
66 => wire__crate__api__wallet__get_chain_upgrade_status_at_height_impl(port, ptr, rust_vec_len, data_len),
67 => wire__crate__api__sync__get_export_birthday_height_impl(port, ptr, rust_vec_len, data_len),
68 => wire__crate__api__voting__get_keystone_signatures_impl(port, ptr, rust_vec_len, data_len),
69 => wire__crate__api__wallet__get_latest_block_height_impl(port, ptr, rust_vec_len, data_len),
70 => wire__crate__api__wallet__get_lightwalletd_chain_name_impl(port, ptr, rust_vec_len, data_len),
71 => wire__crate__api__sync__get_next_available_address_impl(port, ptr, rust_vec_len, data_len),
72 => wire__crate__api__sync__get_next_subtree_indices_impl(port, ptr, rust_vec_len, data_len),
73 => wire__crate__api__sync__get_orchard_migration_immediate_plan_impl(port, ptr, rust_vec_len, data_len),
74 => wire__crate__api__sync__get_orchard_migration_private_plan_impl(port, ptr, rust_vec_len, data_len),
75 => wire__crate__api__sync__get_orchard_migration_status_impl(port, ptr, rust_vec_len, data_len),
76 => wire__crate__api__sync__get_orchard_migration_statuses_impl(port, ptr, rust_vec_len, data_len),
77 => wire__crate__api__sync__get_previous_transaction_count_for_address_impl(port, ptr, rust_vec_len, data_len),
78 => wire__crate__api__wallet__get_recent_transparent_receive_addresses_impl(port, ptr, rust_vec_len, data_len),
79 => wire__crate__api__voting__get_round_plan_impl(port, ptr, rust_vec_len, data_len),
80 => wire__crate__api__voting__get_round_recovery_state_impl(port, ptr, rust_vec_len, data_len),
81 => wire__crate__api__sync__get_shield_transparent_status_impl(port, ptr, rust_vec_len, data_len),
83 => wire__crate__api__sync__get_sync_status_impl(port, ptr, rust_vec_len, data_len),
84 => wire__crate__api__sync__get_transaction_data_requests_impl(port, ptr, rust_vec_len, data_len),
85 => wire__crate__api__sync__get_transaction_detail_impl(port, ptr, rust_vec_len, data_len),
86 => wire__crate__api__sync__get_transaction_history_impl(port, ptr, rust_vec_len, data_len),
87 => wire__crate__api__wallet__get_transparent_receive_address_impl(port, ptr, rust_vec_len, data_len),
88 => wire__crate__api__wallet__get_unified_address_impl(port, ptr, rust_vec_len, data_len),
90 => wire__crate__api__wallet__import_hardware_account_impl(port, ptr, rust_vec_len, data_len),
91 => wire__crate__api__wallet__import_software_account_at_index_impl(port, ptr, rust_vec_len, data_len),
92 => wire__crate__api__wallet__import_software_wallet_with_account_discovery_impl(port, ptr, rust_vec_len, data_len),
93 => wire__crate__api__wallet__import_wallet_impl(port, ptr, rust_vec_len, data_len),
94 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
97 => wire__crate__api__wallet__is_software_wallet_link_account_imported_impl(port, ptr, rust_vec_len, data_len),
100 => wire__crate__api__sync__keystone_migration_proof_status_impl(port, ptr, rust_vec_len, data_len),
102 => wire__crate__api__wallet__list_accounts_impl(port, ptr, rust_vec_len, data_len),
103 => wire__crate__api__voting__mark_delegation_submitted_impl(port, ptr, rust_vec_len, data_len),
104 => wire__crate__api__voting__mark_share_confirmed_impl(port, ptr, rust_vec_len, data_len),
105 => wire__crate__api__voting__mark_vote_submitted_impl(port, ptr, rust_vec_len, data_len),
106 => wire__crate__api__sync__migrate_orchard_to_ironwood_impl(port, ptr, rust_vec_len, data_len),
107 => wire__crate__api__sync__migrate_orchard_to_ironwood_immediately_impl(port, ptr, rust_vec_len, data_len),
108 => wire__crate__api__sync__migrate_orchard_to_ironwood_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
110 => wire__crate__api__voting__next_share_tracking_delay_seconds_impl(port, ptr, rust_vec_len, data_len),
111 => wire__crate__api__voting__parse_signed_voting_pczt_impl(port, ptr, rust_vec_len, data_len),
112 => wire__crate__api__keystone__pczt_spend_nullifiers_impl(port, ptr, rust_vec_len, data_len),
113 => wire__crate__api__voting__plan_share_submissions_impl(port, ptr, rust_vec_len, data_len),
114 => wire__crate__api__voting__precompute_delegation_pir_impl(port, ptr, rust_vec_len, data_len),
115 => wire__crate__api__sync__prepare_orchard_migration_batch_pczt_impl(port, ptr, rust_vec_len, data_len),
116 => wire__crate__api__sync__prepare_orchard_migration_denominations_pczt_impl(port, ptr, rust_vec_len, data_len),
117 => wire__crate__api__sync__prepare_orchard_migration_immediate_pczt_impl(port, ptr, rust_vec_len, data_len),
118 => wire__crate__api__sync__prepare_orchard_migration_outbox_impl(port, ptr, rust_vec_len, data_len),
119 => wire__crate__api__sync__prepare_orchard_migration_single_qr_pczt_impl(port, ptr, rust_vec_len, data_len),
120 => wire__crate__api__wallet__preview_software_account_transparent_balance_impl(port, ptr, rust_vec_len, data_len),
121 => wire__crate__api__sync__propose_send_impl(port, ptr, rust_vec_len, data_len),
122 => wire__crate__api__sync__put_subtree_roots_impl(port, ptr, rust_vec_len, data_len),
123 => wire__crate__api__sync__reconcile_orchard_migration_outbox_receipt_impl(port, ptr, rust_vec_len, data_len),
124 => wire__crate__api__voting__record_share_delegation_impl(port, ptr, rust_vec_len, data_len),
125 => wire__crate__api__voting__recover_vote_commitment_impl(port, ptr, rust_vec_len, data_len),
126 => wire__crate__api__voting__recovered_vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
127 => wire__crate__api__sync__redact_pczt_for_signer_impl(port, ptr, rust_vec_len, data_len),
129 => wire__crate__api__voting__reset_vote_tree_impl(port, ptr, rust_vec_len, data_len),
130 => wire__crate__api__voting__reset_voting_session_state_impl(port, ptr, rust_vec_len, data_len),
131 => wire__crate__api__voting__resolve_static_voting_config_impl(port, ptr, rust_vec_len, data_len),
132 => wire__crate__api__voting__resolve_voting_config_impl(port, ptr, rust_vec_len, data_len),
133 => wire__crate__api__sync__retain_proposal_lock_until_expiry_impl(port, ptr, rust_vec_len, data_len),
134 => wire__crate__api__sync__retire_unbroadcast_orchard_migration_impl(port, ptr, rust_vec_len, data_len),
135 => wire__crate__api__sync__rewind_to_height_impl(port, ptr, rust_vec_len, data_len),
136 => wire__crate__api__sync__run_full_sync_blocking_impl(port, ptr, rust_vec_len, data_len),
137 => wire__crate__api__sync__scan_blocks_impl(port, ptr, rust_vec_len, data_len),
138 => wire__crate__api__voting__set_ballot_intent_impl(port, ptr, rust_vec_len, data_len),
140 => wire__crate__api__sync__set_transaction_status_impl(port, ptr, rust_vec_len, data_len),
141 => wire__crate__api__voting__setup_delegation_bundles_impl(port, ptr, rust_vec_len, data_len),
142 => wire__crate__api__voting__share_tracking_flags_impl(port, ptr, rust_vec_len, data_len),
143 => wire__crate__api__sync__shield_transparent_balance_impl(port, ptr, rust_vec_len, data_len),
144 => wire__crate__api__sync__shield_transparent_balance_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
145 => wire__crate__api__sync__start_full_sync_impl(port, ptr, rust_vec_len, data_len),
146 => wire__crate__api__sync__start_mempool_observer_impl(port, ptr, rust_vec_len, data_len),
148 => wire__crate__api__voting__store_keystone_signature_impl(port, ptr, rust_vec_len, data_len),
149 => wire__crate__api__sync__suggest_scan_ranges_impl(port, ptr, rust_vec_len, data_len),
150 => wire__crate__api__voting__sync_vote_tree_impl(port, ptr, rust_vec_len, data_len),
151 => wire__crate__api__voting__trusted_voting_round_params_from_config_impl(port, ptr, rust_vec_len, data_len),
152 => wire__crate__api__sync__update_chain_tip_impl(port, ptr, rust_vec_len, data_len),
153 => wire__crate__api__sync__validate_address_impl(port, ptr, rust_vec_len, data_len),
155 => wire__crate__api__voting__vote_commitment_wire_json_impl(port, ptr, rust_vec_len, data_len),
156 => wire__crate__api__voting__vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
158 => wire__crate__api__sync__write_block_metadata_impl(port, ptr, rust_vec_len, data_len),
159 => wire__crate__api__keystone__zcash_sign_batch_round_message_counts_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        11 => wire__crate__api__sync__cancel_full_sync_impl(ptr, rust_vec_len, data_len),
        58 => wire__crate__api__wallet__generate_mnemonic_impl(ptr, rust_vec_len, data_len),
        64 => wire__crate__api__sync__get_blocks_dir_impl(ptr, rust_vec_len, data_len),
        82 => wire__crate__api__sync__get_sync_mode_impl(ptr, rust_vec_len, data_len),
        89 => wire__crate__api__simple__greet_impl(ptr, rust_vec_len, data_len),
        95 => wire__crate__api__voting__is_last_moment_impl(ptr, rust_vec_len, data_len),
        96 => wire__crate__api__sync__is_mempool_observer_running_impl(ptr, rust_vec_len, data_len),
        98 => wire__crate__api__sync__is_sync_cancel_requested_impl(ptr, rust_vec_len, data_len),
        99 => wire__crate__api__sync__is_sync_running_impl(ptr, rust_vec_len, data_len),
        101 => {
            wire__crate__api__voting__last_moment_buffer_seconds_impl(ptr, rust_vec_len, data_len)
        }
        109 => wire__crate__api__wallet__mnemonic_word_list_impl(ptr, rust_vec_len, data_len),
        128 => wire__crate__api__keystone__reset_ur_session_impl(ptr, rust_vec_len, data_len),
        139 => wire__crate__api__sync__set_sync_mode_impl(ptr, rust_vec_len, data_len),
        147 => wire__crate__api__sync__stop_mempool_observer_impl(ptr, rust_vec_len, data_len),
        154 => wire__crate__api__wallet__validate_mnemonic_impl(ptr, rust_vec_len, data_len),
        157 => wire__crate__api__wallet__wallet_exists_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::voting::ParsedSignedVotingPczt {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::voting::ParsedSignedVotingPczt
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::voting::ParsedSignedVotingPczt>
    for crate::api::voting::ParsedSignedVotingPczt
{
    fn into_into_dart(self) -> crate::api::voting::ParsedSignedVotingPczt {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::voting::ParsedSignedVotingPczt {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <Vec<u8>>::sse_encode(self.sighash, serializer);
